...
from miml.classifier import MIMLtoMLClassifier, MIMLtoMIBRClassifier, AllPositiveAPRClassifier, APRClassifier, MILESClassifier
from miml.data import load_dataset
from miml.transformation import ArithmeticTransformation, MinMaxTransformation
...
print(dataset_test.get_bag("366").get_labels()[0])
results = classifier_mi.evaluate(dataset_test)
