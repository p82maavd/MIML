            ...
            if line.startswith("@"):
                if not (line.startswith("%")):
                    if line.startswith("@relation"):
                        dataset.setName(line[line.find(" ")+1:])
                ...
                dataset.setNumberLabels(len(labels.split(",")))
                #print("Labels: ", labels)
                ...
                dataset.addBag(key,np.array(valueslist),np.array([int(i) for i in labels.split(',')]))
